...
server.unifiedServer = function(req, res) {
  ...
  debug('trimmedPath', trimmedPath) // eslint-disable-line no-console
  ...
  debug('method', method) // eslint-disable-line no-console
  ...
  const endHander = function() {
    ...
    const handlerCallBack = (statusCode, payload) => {
      ...
      debug('handlerCallBack, statusCode =', statusCode, typeof statusCode) // eslint-disable-line no-console
      ...
      // if the response 200, print green, oterwise print red
      const color = statusCode === 200 ? '\x1b[32m%s\x1b[0m' : '\x1b[31m%s\x1b[0m'
